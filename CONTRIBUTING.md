...
2. **Clone** your fork locally:
   ```sh
   git clone https://github.com/YOUR_USERNAME/rust-auto-commit.git
   cd rust-auto-commit
   ```
3. **Add the upstream remote**:
   ```sh
   git remote add upstream https://github.com/gtkacz/rust-auto-commit.git
   ```
...
Open an [issue](https://github.com/gtkacz/rust-auto-commit/issues/new) with:
